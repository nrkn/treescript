...
exports.deserialize = exports.serialize = exports.isWnode = exports.allIterator = exports.basicUtils = void 0;
const _1 = require(".");
const const_1 = require("./const");
const basicUtils = (node) => {
    const utils = {
        after(...nodes) {
...
const deserialize = (create = (0, _1.wdoc)(exports.basicUtils)) => (value, valueTransformer) => {
